...
![Sin título](https://user-images.githubusercontent.com/62880649/105545534-75a20b00-5cfc-11eb-8141-c79a1c83bef7.png)

Cada partida (vamos a llamarla RUN), se compone de 10 niveles que el jugador debe superar SIN MORIR. Una vez llegado al final del nivel 10 y superado del Boss, finalizará la partida (se explicará el sistema de finales posteriormente)

Los 3 tipos de IDEAS se activarán en momentos determinados de la partida y de los niveles.
Las ACTIVAS y PASIVAS seran al terminar cada una de las salas, a modo de recompensa para el jugador
...
Gracias a David Carmona Fauste (@dcrm_f en twitter), alumno del grado en cuarto curso, que nos compondrá y producirá los temas, dispondremos de una canción con unas 10 variaciones.
-Estilo western
-Piano
-Años 30
-Techno…
...
-Laser 
Único click
Cadencia/entre clicks: muy baja (mini cooldown de carga)
Daño/bala: muy alto
...
##### RUN SUPERADA
Tras superar las 10 niveles y el boss final
###### Finaliza la run
