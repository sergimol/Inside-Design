const Dialogues = {
    ...
    character: [
        ["Pongamos el sprite por defecto."],
        ["Nuestro protagonista debería ser un vaquero."],
        ["Nuestro protagonista debería ser el del Doom."],
        ["Nuestro protagonista debería ser un pirata."],
    ...
    music: [
        ["Pongamos un chiptune de música."],
        ["Que suene un poco de música del oeste."],
        ["A esta música le falta un poco de rock."],
        ["La música necesita infundir un poco de miedo."],
        ["¿Le ponemos música de neones?"],
        ["¿Y si le ponemos música de dibujos animados?"],
        ["Vamos a ponerle música épica."],
        ["Deberíamos poner la música de piano."],
        ["¿Y si cantamos la música nosotros?"],
        ["Pon la música de la intro."]
    ]
